...
def get_features(sample, label, feat_selection: str):
    ...
    switcher = {
        "ptetaphi": lambda: select_features_ptetaphi(sample, label),
        "allfeats": lambda: select_features_all(sample, label),
    }
...
# def select_features_ptetaphi(sample, label):
...
# def select_features_all(sample, label):
